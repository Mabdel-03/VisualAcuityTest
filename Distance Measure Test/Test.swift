...
import UIKit
import DevicePpi
//EXTENSION UIDEVICE IS FOR GETTING MODEL TYPE FROM https://stackoverflow.com/questions/26028918/how-to-determine-the-current-iphone-device-model DONT NEED TO GET MODEL ANYMORE SINCE ALL OF THIS IS BUILT INTO PACKAGE, WE CAN DELETE
extension UIDevice {
...
let modelName = UIDevice.modelName //WE DONT NEED THIS
